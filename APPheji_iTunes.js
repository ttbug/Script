...
[rewrite_local]
^https?:\/\/buy\.itunes\.apple\.com\/verifyReceipt$ url script-response-body https://raw.githubusercontent.com/ttbug/Script/main/APPheji_iTunes.js
...
if (UA && UA.includes("bazaart")) {
  ...
  guding6.latest_receipt_info[0].product_id =
    "com.kobaltlab.HashPhotos.iap.allinone.free";
  guding6.pending_renewal_info[0].product_id =
    "com.kobaltlab.HashPhotos.iap.allinone.free";
  guding8 = true;
  ...
  guding6.pending_renewal_info[0].product_id =
    "com.shengzhou.fileartifact.year";
  guding8 = true;
  ...
  guding6.latest_receipt_info[0].product_id =
    "com.knockout.1monthplus.2weektrail";
  guding6.pending_renewal_info[0].product_id =
    "com.knockout.1monthplus.2weektrail";
  guding8 = true;
  ...
  guding6.latest_receipt_info[0].product_id =
    "me.imgbase.videoday.profeaturesYearly";
  guding6.pending_renewal_info[0].product_id =
    "me.imgbase.videoday.profeaturesYearly";
  guding8 = true;
